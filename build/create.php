...
<head>
  ...
  <style>
 	...
 	.myButton {
		...
		background:-webkit-gradient(linear, left top, left bottom, color-stop(0.05, #FFD342), color-stop(1, #EF8456));
		background:-moz-linear-gradient(top, #FFD342 5%, #EF8456 100%);
		background:-webkit-linear-gradient(top, #FFD342 5%, #EF8456 100%);
		background:-o-linear-gradient(top, #FFD342 5%, #EF8456 100%);
		background:-ms-linear-gradient(top, #FFD342 5%, #EF8456 100%);
		background:linear-gradient(to bottom, #FFD342 5%, #EF8456 100%);
		filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#FFD342', endColorstr='#EF8456',GradientType=0);
	...
	.myButton:hover {
		background:-webkit-gradient(linear, left top, left bottom, color-stop(0.05, #EF8456), color-stop(1, #FFD342));
		background:-moz-linear-gradient(top, #EF8456 5%, #FFD342 100%);
		background:-webkit-linear-gradient(top, #EF8456 5%, #FFD342 100%);
		background:-o-linear-gradient(top, #EF8456 5%, #FFD342 100%);
		background:-ms-linear-gradient(top, #EF8456 5%, #FFD342 100%);
		background:linear-gradient(to bottom, #EF8456 5%, #FFD342 100%);
		filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#EF8456', endColorstr='#FFD342',GradientType=0);
